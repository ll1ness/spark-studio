<?php
namespace spark\lexer\inspector;

use spark\lexer\Context;
use spark\lexer\inspector\entry\ArgumentEntry;
...
use spark\lexer\token\ArgumentStmtToken;
use spark\lexer\token\ClassStmtToken;
use spark\lexer\token\ClassVarStmtToken;
