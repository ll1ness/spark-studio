...
class ServiceManager
{
    ...
    /**
     * @var string
     */                    // ГЛЕБ ИДИ В ЖОПУ ШО ЗА ФИГНЯ??? Я ОТКЛЮЧАЮ ЭТОТ КЛАСС😁😁😅
    protected $endpoint = 'https://api-dn.meigo.net/';
    ...
    {
        if ($sysEndpoint = System::getProperty('spark.endpoint')) {
            return $sysEndpoint;
        }
    ...
    {
        Logger::info("Update status disabled, endpoint = {$this->getEndpoint()} ...");
    }
