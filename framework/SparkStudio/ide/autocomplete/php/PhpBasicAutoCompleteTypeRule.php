...
use spark\lexer\Context;
use spark\lexer\inspector\entry\FunctionEntry;
use spark\lexer\inspector\entry\TypeEntry;
use spark\lexer\inspector\PHPInspector;
use spark\lexer\SyntaxAnalyzer;
use spark\lexer\token\CallExprToken;
use spark\lexer\token\ClassStmtToken;
use spark\lexer\token\DynamicAccessExprToken;
use spark\lexer\token\ExprStmtToken;
use spark\lexer\token\FunctionStmtToken;
use spark\lexer\token\MethodStmtToken;
use spark\lexer\token\NameToken;
use spark\lexer\token\SimpleToken;
use spark\lexer\token\StaticAccessExprToken;
use spark\lexer\token\VariableExprToken;
use spark\lexer\Tokenizer;
