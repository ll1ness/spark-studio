...
use spark\lexer\inspector\AbstractInspector;
...
new StatementAutoCompleteItem('instanceof', 'Проверка типа объекта', 'instanceof '),
new StatementAutoCompleteItem('insteadof', 'Замена методов в интерфейсе', 'insteadof '),
new StatementAutoCompleteItem('true', 'Булево значение истинно', 'true'),
new StatementAutoCompleteItem('false', 'Булево значение ложно', 'false'),
new StatementAutoCompleteItem('null', 'Отсутствие значения', 'null'),
new StatementAutoCompleteItem('as', 'Алиас для класса или интерфейса', 'as '),
new StatementAutoCompleteItem('return', 'Возврат значения из функции', 'return '),
new StatementAutoCompleteItem('goto', 'Перейти к метке', 'goto '),
new StatementAutoCompleteItem('unset', 'Удалить переменную', 'unset(#)'),
new StatementAutoCompleteItem('isset', 'Проверить, установлена ли переменная', 'isset(#)'),
new StatementAutoCompleteItem('empty', 'Проверить, пуста ли переменная', 'empty(#)'),
new StatementAutoCompleteItem('die', 'Прекратить выполнение скрипта', 'die()'),
new StatementAutoCompleteItem('exit', 'Прекратить выполнение скрипта', 'exit()'),
new StatementAutoCompleteItem('interface', 'Объявление интерфейса', 'interface '),
new StatementAutoCompleteItem('trait', 'Объявление трейта', 'trait '),
new StatementAutoCompleteItem('try', 'Попробовать выполнить блок кода', 'try {'),
new StatementAutoCompleteItem('catch', 'Обработка исключений', 'catch (#)'),
new StatementAutoCompleteItem('finally', 'Блок кода, выполняемый после try/catch', 'finally {'),
new StatementAutoCompleteItem('throw new', 'Бросить новое исключение', 'throw new '),
new StatementAutoCompleteItem('extends', 'Наследование класса', 'extends '),
new StatementAutoCompleteItem('implements', 'Имплементация интерфейса', 'implements '),
new StatementAutoCompleteItem('list', 'Развёртывание массива в переменные', 'list(#)'),
...
new StatementAutoCompleteItem('xor', 'Логическое исключающее ИЛИ', 'xor'),
